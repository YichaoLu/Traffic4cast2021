...
from config import DATA_DIRECTORY, CACHE_DIRECTORY, SUBMISSION_DIRECTORY, TRAINING_CITIES, CORE_CHALLENGE_CITIES
from file_utils import write_data_to_h5
from model_v10 import UNet
...
def inference(args: argparse.Namespace):
    ...
    with zipfile.ZipFile(os.path.join(SUBMISSION_DIRECTORY, f'{args.submission_name}.zip'), 'w') as z:
        for city in CORE_CHALLENGE_CITIES:
            ...
            write_data_to_h5(
                ...
                filename=os.path.join(SUBMISSION_DIRECTORY, f'{args.submission_name}_{city}_predictions.h5'),
                compression_level=6
            )
            z.write(
                os.path.join(SUBMISSION_DIRECTORY, f'{args.submission_name}_{city}_predictions.h5'),
