...
def parse_args():
    ...
    parser.add_argument('--random_seed', type=int, default=555)
...
def train(args: argparse.Namespace):
    ...
    train_files = []
    for city in TRAINING_CITIES + CORE_CHALLENGE_CITIES:
        data_files = [file for file in os.listdir(f'../data/{city}/training') if file.endswith('_8ch.h5')]
    ...
    for epoch in range(1, args.num_epochs + 1):
        ...
        }, f'../model/{args.model_name}_epoch_{epoch}.bin')
        gc.collect()
