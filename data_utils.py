...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        file_index = index // self.args.max_time_slot_index
        start_index = index % self.args.max_time_slot_index
    ...
    def __len__(self):
        return len(self.files) * self.args.max_time_slot_index
...
def unified_valid_collate_fn(batch):
